...
class ViewRC extends Component {
  state = {
    data: [],
    errors: "",
  };
  ...
  async componentDidMount() {
    ...
    fetch(
      "https://expresscab.in/CarDriving/driver_Info.php?apicall=GetAllDataOfDriverRcrDetails",
      requestOptions
    )
      ...
      <ScrollView style={{ flex: 1, backgroundColor: Theme.COLORS.PRIMARY }}>
        <Block style={styles.container}>
          {errors != true ? (
                    ...
                    <Block style={styles.container1}>
                      ...
                      <Image
                        ...
                        source={{
                          uri:
                            item.rc_front != null
                              ? `http://expresscab.in/${item.rc_front}`
                              : ImageUri,
                        }}
                      />
                    </Block>
                    <Block style={styles.container1}>
                      ...
                      <Image
                        ...
                        source={{
                          uri:
                            item.rc_back != null
                              ? `http://expresscab.in/${item.rc_back}`
                              : ImageUri,
                        }}
                      />
                    </Block>
            ...
            <Block style={styles.container1}>
              <Text style={styles.text}>Driver RC Details</Text>
              <Text
                style={{
                  fontSize: 15,
                  marginTop: 10,
