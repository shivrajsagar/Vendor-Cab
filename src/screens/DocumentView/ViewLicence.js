...
class ViewLicence extends Component {
  state = {
    data: [],
    errors: "",
  };
  ...
  async componentDidMount() {
    ...
    fetch(
      "https://expresscab.in/CarDriving/driver_Info.php?apicall=GetAllDataOfDriverLicenseDetails",
      requestOptions
    )
      ...
      <ScrollView style={{ flex: 1, backgroundColor: Theme.COLORS.PRIMARY }}>
        <Block style={styles.container}>
          {errors != true ? (
                  ...
                  <>
                    <Block style={styles.container1}>
                      ...
                      <Image
                        ...
                        source={{
                          uri:
                            item.driving_license_front != null
                              ? `http://expresscab.in/${item.driving_license_front}`
                              : ImageUri,
                        }}
                      />
                    </Block>
                    <Block style={styles.container1}>
                      ...
                      <Image
                        ...
                        source={{
                          uri:
                            item.driving_license_back != null
                              ? `http://expresscab.in/${item.driving_license_back}`
                              : ImageUri,
                        }}
                      />
                    </Block>
            ...
            <Block style={styles.container1}>
              <Text style={styles.text}>Driver License Details</Text>
              <Text
                style={{
                  fontSize: 15,
                  marginTop: 10,
              ...
              >
                No Driver License Images Found{"\n"}
                Please Upload
              </Text>
            </Block>
          )}
