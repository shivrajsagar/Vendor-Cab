  ...
  renderIcon = () => {
    ...
    switch (title) {
      ...
      case "Transaction History":
        return (
          <Icon name="select-arrows" family="Entypo" size={20} color="white" />
        );
      case "Pay Commision":
        return (
          <Icon name="calculator" family="Entypo" size={20} color="white" />
        );
      case "Documentation":
        return (
      ...
      case "Change Password":
        return <Icon name="key" family="Entypo" size={20} color="white" />;
      case "Logout":
        return (
          <Icon name="logout" family="AntDesign" size={20} color="white" />
        );
    }
  };
